<div align="center">
  <img src="https://media.tenor.com/rePDfDWO3XoAAAAd/hacking.gif" width="600" height="250" alt="hacking gif"/>
</div>
...
- 🎯 **Focus** — Web Application Security, API Penetration Testing, Secure SDLC
- 🏆 **Experience** — 15+ Years in IT | 5+ Years in Offensive Security
- 🔎 **Speciality** — Finding what automated scanners miss — logic flaws, second-order injection, auth bypass chains
- 🎓 **Pursuing** — OSCP (OffSec) | Executive Cert in Cyber Security — IIT Kanpur (2025–2026)
- 📝 **Sharing** — Enterprise pentest field notes, real vulnerability write-ups & testing methodology
- 💡 **Background** — Started as a full-stack developer (ASP.NET / SQL Server) — that developer mindset is my biggest edge in finding application-layer vulnerabilities
...
[![Burp Suite](https://img.shields.io/badge/Burp%20Suite-FF6F00?style=plastic)](https://portswigger.net/burp)
...
🐛 Vulnerabilities ████████████████████████████  200+ critical & high findings
🏢 Applications    ████████████████████          20+ enterprise apps tested
👥 Mentored        ████████████                  15+ engineers on secure coding
📉 Risk Reduction  ████████████████████████████  35% external attack surface reduced
```
...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
  <div>
    <ul>
      <li>[![Bug Bounty Hunting Checklist](https://github-readme-stats.vercel.app/api/pin/?username=dheeraj-jayaswal&repo=Bug-Bounty-Hunting-    Companion&theme=tokyonight&hide_border=true)](https://github.com/dheeraj-jayaswal/Bug-Bounty-Hunting-Companion)
      </li>
    </ul>
  </div>
  <div>
...
> *If you understand why code was written a certain way,*
> *you'll always find more than a scanner ever will."*
...
**#AppSec · #PenTest · #WebSecurity · #APISecuity · #OffensiveSecurity · #DevSecOps**
